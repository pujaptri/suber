...
<body>
    ...
    <table class="meta-table">
        ...
        <tr>
            <td>Total Dokumen</td>
            <td>:</td>
            <td>{{ count($suratKeluar) }} Surat Keluar</td>
            <td>Status Server</td>
            <td>:</td>
            <td>ONLINE</td>
        </tr>
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th style="width: 12%;">Kategori/Sifat</th>
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($surat->status === 'disetujui')
                            <span class="badge badge-status-disetujui">Disetujui</span>
            ...
            @empty
                <tr>
                    <td colspan="7" class="text-center" style="color: #9ca3af; padding: 20px 0;">Tidak ada data surat keluar ditemukan.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
